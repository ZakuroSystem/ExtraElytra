...
- Right-click cycles ECO, ENGINE STOP (idles at 10% fuel usage), and normal output while gliding
...
- Engines ramp to full thrust over two seconds after being equipped to prevent sudden acceleration spikes
